...
class RectangularRoom(object):
    ...
    def clean_tile_at_position(self, pos, capacity):
        ...
        self.tiles[(x, y)] = max(self.tiles[(x, y)] - capacity, 0)
...
class Robot(object):
    ...
    def __init__(self, room, speed, capacity):
        ...
        x, y = random.random() * room.width, random.random() * room.height
...
class StandardRobot(Robot):
    ...
    def update_position_and_clean(self):
        ...
        direction, speed = self.get_robot_direction(), self.speed
        new_position = current_position.get_new_position(direction, speed)
        ...
        if self.room.is_position_valid(new_position):
            ...
            angle = random.random() * 360
            self.set_robot_direction(angle)
...
def show_plot_compare_strategies(title, x_label, y_label):
    ...
    for num_robots in num_robot_range:
        ...
        times1.append(run_simulation(num_robots, 1.0, 1,
                                     20, 20, 3, 0.8, 20, StandardRobot))
        times2.append(run_simulation(num_robots, 1.0, 1,
                                     20, 20, 3, 0.8, 20, FaultyRobot))
...
def show_plot_room_shape(title, x_label, y_label):
    ...
    for width in [10, 20, 25, 50]:
        ...
        times1.append(run_simulation(2, 1.0, 1, width,
                                     height, 3, 0.8, 200, StandardRobot))
        times2.append(run_simulation(2, 1.0, 1, width,
                                     height, 3, 0.8, 200, FaultyRobot))
